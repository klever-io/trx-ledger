...
// TRON defined:
#define E_INCORRECT_BIP32_PATH 0x6a81
#define E_MISSING_SETTING_DATA_ALLOWED 0x6a82
#define E_MISSING_SETTING_SIGN_BY_HASH 0x6a83
#define E_MISSING_SETTING_CUSTOM_CONTRACT 0x6a84
