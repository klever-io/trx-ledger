...
typedef struct _protocol_AssetIssueContract { 
    pb_callback_t owner_address; 
    pb_callback_t name; 
    pb_callback_t abbr; /* the name of target asset */
    int64_t total_supply; /* the amount of drops */
...
typedef struct _protocol_ExchangeInjectContract { 
    ...
    protocol_ExchangeInjectContract_token_id_t token_id; /* Can be empty */
...
typedef struct _protocol_UpdateAssetContract { 
    pb_callback_t owner_address; 
    pb_callback_t description; 
    pb_callback_t url; /* add or remove approval */
    int64_t new_limit; 
